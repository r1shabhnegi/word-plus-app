...
const Home = () => {
  return (
    <main
      ...
      <Link to={'search-page'}>
        <button className='text-white text-2xl tracking-normal bg-gray-800 rounded-lg px-7 py-6 m-16 font-sans hover:bg-gray-700 ease-in-out duration-300 hover:text-3xl hover:px-8 hover:py-7 hover:m-14'>
          Find words
        </button>
      </Link>
    </main>
